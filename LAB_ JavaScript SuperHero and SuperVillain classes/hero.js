...
function selectionChanged() {
	...
	// Your code goes hero
	winner=selectedHero.battle(selectedVillain)
	if(winner==true){
		document.getElementById("winner").innerHTML=("Winner: "+String(selectedHero.alias)+"!")
	}
	else{
		document.getElementById("winner").innerHTML=("Winner: "+String(selectedVillain.alias)+"!")
